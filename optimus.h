...
class brain_t final {
 public:
   ...
   * @brief 
   * 
   * @param motors_positions - all motors positions from previous call to a net function
   * @param robot_positions - all robot positions from previous call to a net function
   * @return motors_positions_t required new motors positions
   */
  //typedef motors_positions_t (*net_function_sig)(vector<motors_positions_t>&&, vector<robot_position_t>&&);
  // using net_function_t = typename std::function< net_function_sig >;
  using net_function_t = typename std::function< motors_positions_t(vector<motors_positions_t>&&, vector<robot_position_t>&&) >;
   ...
   * 
   * @param name 
   * @param net_function, if the net function object is empty, then an already registered net function for @name will be removed 
